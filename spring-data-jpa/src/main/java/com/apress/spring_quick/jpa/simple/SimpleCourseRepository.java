...
/**
 * Simple repository interface for {@link Course} instances. The interface is used to declare so called query methods,
 * methods to retrieve single entities or collections of them.
 */
@Repository
public interface SimpleCourseRepository extends CrudRepository<Course, Long> {
