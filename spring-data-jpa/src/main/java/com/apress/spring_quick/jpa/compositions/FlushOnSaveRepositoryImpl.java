...
public class FlushOnSaveRepositoryImpl<T> implements FlushOnSaveRepository<T> {
    ...
    @Transactional
    @Override
    public <TYPE extends T> TYPE save(TYPE entity) {
     ...
     * @param entity
     */
    private <TYPE extends T> void doSave(TYPE entity) {

        EntityInformation<TYPE, ?> entityInformation = getEntityInformation(entity);
    ...
    @Transactional
    @Override
    public <TYPE extends T> Iterable<TYPE> saveAll(Iterable<TYPE> entities) {
    ...
    private <TYPE extends T> EntityInformation<TYPE, ?> getEntityInformation(TYPE entity) {
